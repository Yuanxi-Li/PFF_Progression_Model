function outputs_all = PFF_TestRandomConnectome(varargin)
% Test whether random connectomes (uniform distribution) can predict the PFF progression.
...
for BootstrapNum = 1:1000 % Bootstrap for 1,000 times. Randomly generate 1,000 matrices with uniform distribution as 'null connectome'.
    try
        rng(BootstrapNum)
        C = rand(410,410);
        ...
        %% Result output: 1,000 bootstraps.
