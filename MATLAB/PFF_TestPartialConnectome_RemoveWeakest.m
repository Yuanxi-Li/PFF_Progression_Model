function [outputs_all] = PFF_TestPartialConnectome_RemoveWeakest(varargin)
% Remove the elements of the connectome orderly by percentile, from Weakest
...
SaveFileName = append('RemoveWeakest.mat');
