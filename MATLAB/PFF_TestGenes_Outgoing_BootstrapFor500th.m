function outputs_all = PFF_TestGenes_Outgoing_BootstrapFor500th(varargin)
% Conducted bootstrapping for each group,s 500th gene, outgoing effect 
...
for Bootstrap_Num = 1:1200
    ...
    try
        ...
        C = Gene_expression_diag*C;  % Gene_expression_diag*C → gene expression effect on outgoing connections alone;  
