function outputs_all = PFF_TestGenes_Incoming_BootstrapFor500th(varargin)
% Conducted bootstrapping for each group,s 500th gene, incoming effect
...
for Bootstrap_Num = 1:1200
    % Perform 1,200 times. 
    % Some cases can not be fit. Test 1,200 times and pick the first 1,000 results for further analyses.
    try
        ...
        C = C*Gene_expression_diag;  % C*Gene_expression_diag → gene expression effect on incoming connections alone (incoming);
