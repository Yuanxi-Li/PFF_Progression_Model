function outputs_all = PFF_TestPermutatedConnection(varargin)
% Test whether randomly permutating the elements of the actual connectome can predict the PFF progression.
...
for BootstrapNum = 1:1200
    % Generate 1,200 matrices with randomly permutating the elements of the actual connectome
    ...
    try
        ...
        RandomOrder = reshape(RandomOrder,410,410);
        C = C(RandomOrder);
