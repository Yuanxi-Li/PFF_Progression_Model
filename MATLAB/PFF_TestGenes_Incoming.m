function outputs_all = PFF_TestGenes_Incoming(varargin)
% Test gene expression effect on incoming connections alone (incoming effect)
...
for gene_num = 1:length(gene_names)
    ...
    try
        ...
        C = C*Gene_expression_diag; % C*Gene_expression_diag → gene expression effect on incoming connections alone;
